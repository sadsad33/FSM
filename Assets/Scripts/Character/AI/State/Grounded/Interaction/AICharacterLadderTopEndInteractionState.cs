...
namespace KBH {
    public class AICharacterLadderTopEndInteractionState : AICharacterGroundedInteractionState {
        ...
        public override void Enter(CharacterManager character) {
            ...
            if (aiCharacter.rightFootUp) aiCharacter.aiAnimatorManager.PlayAnimation("Ladder_End_Top_RightFootUp", aiCharacter.isPerformingAction);
            else aiCharacter.aiAnimatorManager.PlayAnimation("Ladder_End_Top_LeftFootUp", aiCharacter.isPerformingAction);
